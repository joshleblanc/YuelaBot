...
ActiveRecord::Schema.define(version: 2020_08_14_110607) do
  ...
  create_table "so_chat_cookies", force: :cascade do |t|
    t.string "email"
    t.string "cookie"
    t.string "url"
    t.bigint "user_id"
    t.index ["user_id"], name: "index_so_chat_cookies_on_user_id"
  end
